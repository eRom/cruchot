...
### Installer un Skill
1. Allez dans **Personnaliser** (`Cmd+U`) > onglet **Skills**.
...
1. Allez dans **Personnaliser** (`Cmd+U`) > onglet **MCP**.
...
1. Dans votre conversation, ouvrez le **Panneau de Droite** (`Opt+Cmd+B`).
2. Allez dans la section **MCP**.
3. Activez les serveurs que vous souhaitez rendre disponibles pour cette conversation.
