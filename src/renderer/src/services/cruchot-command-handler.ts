import type { GeminiLiveCommandResult } from '../../../preload/types'

type CommandHandler = (args: Record<string, unknown>) => Promise<GeminiLiveCommandResult>
...
class CruchotCommandHandler {
  ...
  async execute(name: string, args: Record<string, unknown>): Promise<GeminiLiveCommandResult> {
  ...
  private async navigateTo(args: Record<string, unknown>): Promise<GeminiLiveCommandResult> {
  ...
  private async toggleUi(args: Record<string, unknown>): Promise<GeminiLiveCommandResult> {
  ...
  private async changeModel(args: Record<string, unknown>): Promise<GeminiLiveCommandResult> {
  ...
  private async changeThinking(args: Record<string, unknown>): Promise<GeminiLiveCommandResult> {
  ...
  private async sendPrompt(args: Record<string, unknown>): Promise<GeminiLiveCommandResult> {
  ...
  private async listConversations(args: Record<string, unknown>): Promise<GeminiLiveCommandResult> {
  ...
  private async listModels(): Promise<GeminiLiveCommandResult> {
    const { useProvidersStore } = await import('@/stores/providers.store')
